<?php
// Split articles: first one is featured, the rest go to the grid
$featuredPage = null;
$gridPages = [];
if (!empty($content)) {
...
<div class="np-site-header">
	<div class="container">
		<div class="np-site-header-inner">
			<h1 class="np-site-title"><?php echo $site->slogan(); ?></h1>
			<?php if ($site->description()): ?>
				<p class="np-site-description"><?php echo $site->description(); ?></p>
			<?php endif ?>
		</div>
	</div>
</div>
...
<!-- Featured Article -->
<?php if ($featuredPage): ?>
<section class="np-featured" aria-label="<?php echo $L->get('Featured article'); ?>">
	<div class="container">
		<article class="np-featured-card" itemscope itemtype="https://schema.org/NewsArticle">
			<!-- Hidden SEO metadata -->
			...
			<a href="<?php echo $featuredPage->permalink(); ?>" class="np-featured-img-link" tabindex="-1" aria-hidden="true">
				<div class="np-featured-img-wrap">
					<img class="np-featured-img" src="<?php echo $featuredPage->coverImage(); ?>"
			...
			<div class="np-featured-body">
				...
				<!-- Title -->
				<h2 class="np-featured-title" itemprop="headline">
					<a href="<?php echo $featuredPage->permalink(); ?>" itemprop="url"><?php echo $featuredPage->title(); ?></a>
				</h2>

				<!-- Description -->
				<?php if ($featuredPage->description()): ?>
				<p class="np-featured-desc" itemprop="description"><?php echo $featuredPage->description(); ?></p>
				<?php endif ?>
			...
			<!-- Load Bludit Plugins: Page Begin / End -->
...
<section class="np-grid-section" aria-label="<?php echo $L->get('Latest articles'); ?>">
	<div class="container">
		<div class="np-grid">
